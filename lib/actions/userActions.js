...
export const getCurrentUser = async () => {
  try {
    ...
    // Then try to get the user from database
    try {
      ...
      console.log("Database error while fetching user:", dbError.message);
      return null;
    }
  } catch (error) {
    console.log("General error in getCurrentUser:", error.message);
    return null;
  }
};
