      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
        <div className="p-3 sm:p-4 lg:p-6">
          <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              ...
              {currentFile?.url && (
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                  ...
                  <div className="p-3 sm:p-4 flex justify-center bg-gray-50">
                    <div className="relative w-full max-w-sm sm:max-w-md h-48 sm:h-64 rounded-lg overflow-hidden border-2 border-gray-200">
                      <Image
                        src={currentFile.url}
              ...
              >
                <div className="flex flex-col items-center justify-center space-y-3 sm:space-y-4">
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      document.getElementById("mouth-upload").click();
                    }}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <Button
                ...
                className={`w-full mt-4 sm:mt-6 py-4 sm:py-6 text-sm sm:text-base font-medium transition-colors ${
              ...
              {isAnalyzing && !imageResult && (
                <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-blue-50 border border-blue-100 rounded-lg">
                  <div className="flex items-center">
                    <svg
                      className="animate-spin h-5 w-5 sm:h-6 sm:w-6 text-blue-500 mr-3"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                    >
              ...
              {imageResult && (
                <div
                  className={`mt-6 sm:mt-8 p-4 sm:p-5 rounded-lg ${getPredictionColor(
                ...
                >
                  <div className="flex items-start">
                    <div className="flex-shrink-0 pt-0.5">
                      {imageResult.prediction.toLowerCase() === "normal" ? (
                        <svg
                          className="w-5 h-5 sm:w-6 sm:h-6 text-green-500 mr-3"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                        ...
                        <svg
                          className="w-5 h-5 sm:w-6 sm:h-6 text-amber-500 mr-3"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                  ...
                  {handleNext && (
                    <Button
                      onClick={handleNext}
                      className="mt-4 bg-brand-100 hover:bg-brand-200 text-white w-full sm:w-auto"
                    >
            ...
            {/* Tips Section */}
            <div className="lg:border-l lg:pl-6 mt-6 lg:mt-0">
